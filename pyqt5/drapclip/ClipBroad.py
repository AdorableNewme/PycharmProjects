...
class ClipBoard(QDialog):
    def __init__(self):
        ...
        self.imageLabel.setPixmap(QPixmap('C:/Users/xlh\PycharmProjects\pyqt5\controls\images\dafeng.png'))
    ...
    def copyImage(self):
        clipboard = QApplication.clipboard()
        clipboard.setPixmap(QPixmap('C:/Users/xlh\PycharmProjects\pyqt5\controls\images\python图标.png'))
